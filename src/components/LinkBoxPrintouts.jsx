  ...
  return (
    <div>
      <div
        ...
        className="link-box-printouts flex flex-col items-center justify-center w-64 h-64 m-8 p-4 bg-gradient-to-br from-ggSilver to-ggWhite border-2 border-ggPurple hover:border-ggBlue rounded-2xl shadow-2xl"
      >
